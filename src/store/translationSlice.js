...
enMap.set('download2','Click to download')
...
enMap.set('performancesHeaderBtn','Shows')
enMap.set('donateHeaderBtn','Donate')
enMap.set('contactHeaderBtn','Contacts')
...
enMap.set('performancesHeader2','The chants we often perform at the liturgy:')
enMap.set('performancesProgram','PROGRAM')
enMap.set('performancesEktenia1','1. THE GREAT EKTENIA - K. Shvedov')
...
ruMap.set('download', 'СКАЧАТЬ НОТЫ')
ruMap.set('download2', 'СКАЧАТЬ ПРОГРАММУ')
...
ruMap.set('performancesHeaderBtn','Репертуар')
...
ruMap.set('performancesHeader2','Песнопения которые мы часто исполняем на литургии:')
ruMap.set('performancesProgram','ПРОГРАММА')
ruMap.set('performancesEktenia1','1. ЕКТЕНИЯ ВЕЛИКАЯ – К. Шведов')
...
ruMap.set('currentProgram','РЕПЕРТУАР')
...
ruMap.set('view','Посмотреть')
ruMap.set('donate2','Донат')
